    ...
    <section class="page"
        ...
        <div class="section-content-container automenu">
            ...
            <div class="section-sub-section">
				...
				<p>ClanAOD.net built the ClanAOD app as a Free app. This SERVICE is provided by
                    ClanAOD.net at no cost and is intended for use as is.</p>
                    ...
                    accessible at ClanAOD unless otherwise defined in this Privacy Policy.</p>
					<h2>Information Collection and Use</h2>
					<p>For a better experience, while using our Service, we may require you to provide us with certain
                    personally identifiable information, including but not limited to E-Mail Address, Birthdate. The information
					that we request will be retained by us and used as described in this privacy policy.</p>
					<p>The app does use third party services that may collect information used to identify you.</b></p>
					<p><b>Link to privacy policy of third party service providers used by the app</p>
					<ul>
