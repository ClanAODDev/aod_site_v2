...
@section('content')
    ...
    <section class="supported-games with-shadow">
        <div class="section-content-container section--centered ">
            <h2 class="slide-in-right animate">Engaged in <strong>{{ count($aod_divisions) }}</strong> major titles <br>with more than
                <strong>1200</strong> active members </h2>
        ...
        <div class="section-content-container  ">
            <div class="section--short-width">
                <div class="section-blurb slide-in-left animate">
                    <h2>Founded in <strong>1999</strong><br>and still growing! </h2>
    ...
    <section class="section with-shadow"
        ...
        <div class="section-content-container section--centered">
            <h2 class="slide-in-left animate">Belong to something <strong>unique</strong> and<br>worldwide that <strong>endures</strong>
                through time
            </h2>
    ...
    <section class="social-media with-shadow">
        <div class="section-content-container section--centered">
            <h2 class="animate slide-in-left animate-delay-0">Catch up with us on social media</h2>
            <div class="section-blurb">
                ...
                <div class="social-icons">
                    <a href="https://discord.gg/clanaod" class="social-icon discord animate drop-up animation-delay-1" title="Discord" rel="noopener noreferrer" target="_blank">
                    ...
                    <a href="https://www.twitch.tv/clanaodstream" class="social-icon twitch animate drop-up animation-delay-2" title="Twitch" rel="noopener noreferrer" target="_blank">
                    ...
                    <a href="https://twitter.com/officialclanaod" class="social-icon twitter animate drop-up animation-delay-3" title="X / Twitter" rel="noopener noreferrer" target="_blank">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        <span>X</span>
                    </a>
                    <a href="https://steamcommunity.com/groups/clanaod" class="social-icon steam animate drop-up animation-delay-4" title="Steam" rel="noopener noreferrer" target="_blank">
                    ...
                    <a href="https://www.youtube.com/ClanAODnet" class="social-icon youtube animate drop-up animation-delay-5" title="YouTube" rel="noopener noreferrer" target="_blank">
    ...
    <section class="merch-section with-shadow">
        <div class="section-content-container section--centered">
            <h2 class="animate slide-in-left">Rep the Angels of Death</h2>
            <div class="section-blurb">
