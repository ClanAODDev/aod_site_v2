...
@section('content')
    ...
    <section class="supported-games with-shadow">
        <div class="section-content-container section--centered ">
            <h1>Engaged in <strong>18</strong> major titles <br>with more than <strong>2500</strong> active members
            </h1>
    ...
    <section class="section with-shadow"
        ...
        <div class="section-content-container section--centered ">
            <h1>Belong to something <strong>unique</strong> and<br>worldwide that <strong>endures</strong> through time
            </h1>
            <div class="section-blurb">
    ...
    <section class="social-media with-shadow">
        <div class="section-content-container section--centered ">
            ...
            <div class="section-blurb">
                <p>Grab one of the hundreds of seats in our hosted VOIP amphitheater while working your WASD and, when
                    you have to leave your mechanical keys, keep up to date by following our social feeds.</p>
