<section class="division" data-application-id="65"
    ...
    <div class="section-content-container">
        <div id="sub-nav">
            <ul>
                <li><a href="#ports,-events-&amp;-badges" class="smooth-scroll">
                        Ports, Events &amp; Badges
                    </a></li>
        ...
        <div class="section-sub-section automenu">
            ...
            <p>Welcome to the World of Warships Division of AOD where we unleash hellfire and furious steel on the seas
                ...
                lightning-fast strikes with destroyers, AOD aims to provide its members with a sustained and engaging
                naval combat experience. We’re looking for Captains interested in just sinking boats, Operations, Naval
        ...
        <div class="section-sub-section automenu">
            <h2 id="ports,-events-&amp;-badges">
                Ports, Events &amp; Badges
            </h2>

            <p>Our five (5) NA ports and two (2) EU ports actively participate in Clan Battles. Last season we had three
                teams finish in the Storm Division, Group II and III respectively. We also hold our own weekly,
        ...
        <div class="section-sub-section automenu">
            ...
            <ul>
                ...
                <li>Active in WoWS at least once every 30 days</li>
            </ul>
