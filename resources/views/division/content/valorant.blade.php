<section class="division" data-application-id="87"
         style="background: url({{ asset('images/division-headers/val.jpg') }}) no-repeat, url('{{ asset('images/division-bg-border.jpg') }}') repeat-x; background-position: top center;">
    <div class="section-content-container">
        ...
        <div id="general" class="game-header">
            <img class="game" src="{{ asset('images/division-icons/val.png') }}">
