...
<div class="section-sub-section automenu">
    <h2 id="what-you-need-to-do">Apply to division</h2>
    <p>In order to be eligible for membership in the Lost Ark division, you must meet the following criteria:</p>
    <ul>
        ...
        <li>Be one with the Mokoko seeds</li>
    </ul>
</div>
