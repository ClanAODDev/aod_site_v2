...
export default function AndroidAppPrivacyPolicy() {
    return (
        <LegalPage title="Android App Privacy Policy">
            <h1>Privacy Policy of ClanAOD.net</h1>
            <p>
                ClanAOD.net built the ClanAOD app as a Free app. This SERVICE is provided by ClanAOD.net at no cost and is intended for use as
                is.
            </p>
            <p>This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service.</p>
            <p>
                If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The
            ...
            <p>
                The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at ClanAOD
            ...
            <p>
                ...
                information, including but not limited to E-Mail Address, Birthdate. The information that we request will be retained by us and
            ...
            <p>
                ...
                Protocol (&ldquo;IP&rdquo;) address, device name, operating system version, the configuration of the app when utilizing our
            ...
            <p>
                ...
                browser from the websites that you visit and are stored on your device&rsquo;s internal memory.
            </p>
            <p>
                This Service does not use these &ldquo;cookies&rdquo; explicitly. However, the app may use third party code and libraries that
                use &ldquo;cookies&rdquo; to collect information and improve their services. You have the option to either accept or refuse these
                cookies and know when a cookie is being sent to your device. If you choose to refuse our cookies, you may not be able to use some
            ...
            <p>
                We want to inform users of this Service that these third parties have access to your Personal Information. The reason is to
            ...
            <p>
                ...
                <a href="https://privacypolicytemplate.net" target="_blank" rel="noreferrer">
                    privacypolicytemplate.net
                </a>{' '}
                and modified/generated by{' '}
                <a href="https://app-privacy-policy-generator.firebaseapp.com/" target="_blank" rel="noreferrer">
