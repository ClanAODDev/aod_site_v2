...
export default function PrivacyPolicy() {
    return (
        <LegalPage title="Privacy Policy">
            ...
            <p>ClanAOD.net operates the https://www.clanaod.net website, which provides the SERVICE.</p>
            <p>
                This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal
                Information if anyone decided to use our Service, the ClanAOD.net website.
            </p>
            <p>
                ...
                Personal Information that we collect are used for providing and improving the Service. We will not use or share your information
            ...
            <p>
                ...
                https://www.clanaod.net/terms-of-use/, unless otherwise defined in this Privacy Policy. Our Privacy Policy was created with the
                help of the{' '}
                <a href="https://www.privacypolicytemplate.net" target="_blank" rel="noreferrer">
            ...
            <p>
                ...
                information, including but not limited to your user name, email, and Internet Protocol (&ldquo;IP&rdquo;) address. The
            ...
            <p>
                ...
                Log Data. This Log Data may include information such as your computer&rsquo;s Internet Protocol (&ldquo;IP&rdquo;) address,
                browser version, pages of our Service that you visit, the time and date of your visit, the time spent on those pages, and other
                statistics.
            </p>
            ...
            <p>
                ...
                from the website that you visit and are stored on your computer&rsquo;s hard drive.
            </p>
            <p>
                Our website uses these &ldquo;cookies&rdquo; to collection information and to improve our Service. You have the option to either
            ...
            <p>
                We may update our Privacy Policy from time to time. Thus, we advise you to review this page periodically for any changes. We
                will notify you of any changes by posting the new Privacy Policy on this page. These changes are effective immediately, after
