    ...
    return (
        <SiteLayout>
            ...
            <section className="mx-auto max-w-6xl px-4 py-16">
                <div className="mb-16 max-w-xl text-right md:ml-auto">
                ...
                {divisions.length === 0 ? (
                    <p className="text-center text-muted-foreground">No divisions to display</p>
                ) : (
                        ...
                        {divisions.map((division, index) => (
                            ...
                            >
                                ...
                                <div className="leading-relaxed">
                                    <div className="font-semibold text-foreground transition-colors group-hover:text-primary">{division.name}</div>
