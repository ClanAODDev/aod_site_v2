...
export function MerchSection({ items: allItems, storeUrl, imageBaseUrl, imageSuffix }: MerchSectionProps) {
    ...
    return (
        <section className="bg-gradient-to-b from-[#0a0a0a] via-[#151515] to-[#0a0a0a] py-20">
            ...
            <div className="mt-10 grid grid-cols-2 [grid-auto-flow:dense] auto-rows-[130px] gap-3 px-3 sm:grid-cols-4 sm:auto-rows-[150px] lg:grid-cols-6 lg:auto-rows-[170px]">
                {items.map((item, i) => {
