...
!function (e) {
  ClanAOD = {
    ...
    addDynamicLinks: function addDynamicLinks() {
    ...
    handleApplicationLinks: function handleApplicationLinks() {
    ...
    initAutoMenu: function initAutoMenu() {
    ...
    handleModals: function handleModals() {
...
__webpack_require__(/*! ./easyModal.min */ "./resources/js/easyModal.min.js");
/**
...
!function (n, t) {
  var e = function e(n, t, _e) {
    var o;
    return function () {
      function i() {
        _e || n.apply(a, s), o = null;
      }

      var a = this,
          s = arguments;
      o ? clearTimeout(o) : _e && n.apply(a, s), o = setTimeout(i, t || 100);
    };
  };
...
}(jQuery, "smartModalResize"), function (n) {
  var t = {
    init: function init(t) {
      ...
      return t = n.extend(e, t), this.each(function () {
        ...
        o.css({
          display: "none",
          position: "fixed",
          "z-index": e.updateZIndexOnOpen ? 0 : e.zIndex(),
          top: 0,
          left: 0,
          height: "100%",
          width: "100%",
        ...
        }), i.on("click", e.closeButtonClass, function (n) {
  ...
  n.fn.easyModal = function (e) {
    return t[e] ? t[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != _typeof(e) && e ? void n.error("Method " + e + " does not exist on jQuery.easyModal") : t.init.apply(this, arguments);
  };
}(jQuery);
...
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/app"], () => (__webpack_require__("./resources/src/main.styl")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/fonts","css/app"], () => (__webpack_require__("./resources/fonts/fonts.css")))
